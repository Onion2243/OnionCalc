...
from Files.functions import OnionMath
            ...
            try:
                ...
                if Mode == 2:
                    ...
                    if Mode2 == 4:
                        ...
                        variables = SymPy.symbols("a b c d e f g h i j k l m n o p q r s t u v w x y z")

                        # Create A SymPy Function
                        function = SymPy.Function('F')(variables)
                        ...
                        solution = expression.subs(variables, function)
